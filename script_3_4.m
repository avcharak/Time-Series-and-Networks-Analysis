...
% for estimation of embedding dimension

function fnnM = falsenearest(xV,tau,mmax)
% fnnM = falsenearest(xV,tau,mmax,escape,theiler,tittxt)
% FNN computes the false nearest neighbors for a range of
...
plot(fnnM(:,2),'-o');title('FNN');xlabel('m');ylabel('FNN(m)')
print -dmeta
